...
//        Intent shoot = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//        if(shoot.resolveActivity(getPackageManager())!= null) {
//            startActivityForResult(shoot,REQUEST_IMAGE_CAPTURE);
//        }
